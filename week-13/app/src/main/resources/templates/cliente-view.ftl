                ...
                <#else>
                    <form method="post" action="/cliente/criar">
                        ...
                        <div class="form-group">
                            ...
                            <input value="${(clienteAtual.nome)!}" name="nome" type="text" class="form-control" id="nome" placeholder="Brasil">
                        </div>
                        <div class="form-group">
                            <label for="idade">Idade:</label>
                            <input value="${(clienteAtual.idade)!}" name="idade" type="text" class="form-control" id="idade" placeholder="BR">
                        </div>
                         <div class="form-group">
                            <label for="telefone">Telefone:</label>
                            <input value="${(clienteAtual.telefone)!}" name="telefone" type="text" class="form-control" id="telefone" placeholder="BR">
                        </div>
                         <div class="form-group">
                            <label for="limiteCredito">Limite de Credito:</label>
                            <input value="${(clienteAtual.limiteCredito)!}" name="limiteCredito" type="text" class="form-control" id="limiteCredito" placeholder="BR">
                        </div>
                    </form>
                </div>
